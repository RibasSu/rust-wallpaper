...
function animateIntensity() {
  t += 0.01;
  sphereRad = 280 + 100 * Math.sin(t * 0.2);
  radius_sp = 1 + 0.5 * Math.sin(t * 0.1);

  // Ciclo linear de hue para garantir passagem por azul, vermelho, violeta e verde
  // Azul (0.66), Vermelho (0), Violeta (0.8), Verde (0.33)
  let colorStops = [0, 0.33, 0.66, 0.8, 1];
  let cycle = (t * 0.05) % 1;
  let hue;
  if (cycle < 0.25) {
    // Vermelho para Verde
